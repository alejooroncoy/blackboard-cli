---
title: "Cómo anticiparte a las observaciones de tu profesor antes de entregar"
seoTitle: "Revisar tu entrega contra el enunciado y la rúbrica con IA"
ogTitle: "Las cuatro observaciones de mi profesor ya estaban escritas"
description: "Saqué 16.5 en un avance de proyecto y mi profesor dejó cuatro observaciones. Fui a buscarlas al enunciado y a la rúbrica: las cuatro estaban ahí desde el principio."
...
compare:
  caption: "El mismo avance, revisado de dos formas"
  before:
    title: "Revisándolo a mano, de madrugada"
    items:
      ...
      - "166 MB por subir"
    cost: "Entregado 01:16 a. m. · 16.5 de 20"
  after:
    title: "Preguntándole a Campus"
    question: "¿Mi avance cumple lo que piden el enunciado y la rúbrica de este curso?"
    answer: "Faltan tres cosas: el Anexo A del Student Outcome no tiene una subsección por integrante, los archivos no siguen la nomenclatura upc-pre-202610-… y hay segmentos con menos de 3 entrevistas."
    cost: "1 pregunta · antes de entregar, no después"
howTo:
  name: "Cómo revisar tu entrega contra el enunciado y la rúbrica antes de enviarla"
  totalTime: "PT15M"
  steps:
    - name: "Junta las dos fuentes, no una"
      text: "Descarga el enunciado del proyecto y abre además la rúbrica desde el libro de calificaciones. Son documentos distintos y ninguno contiene al otro: el enunciado dice qué secciones escribir y la rúbrica dice con qué criterios te van a puntuar."
    - name: "Convierte el índice del enunciado en una lista de verificación"
      text: "Cada subsección numerada del enunciado es una casilla. Si el enunciado pide 60, tu lista tiene 60 líneas. Marca cuáles existen de verdad en tu documento y cuáles están solo como título."
    - name: "Revisa los requisitos que se cuentan"
      text: "Busca en el enunciado los números concretos: cuántas entrevistas por segmento, cuántos endpoints, cuántas horas por tarea. Son los más fáciles de incumplir sin darte cuenta y los más fáciles de verificar."
    - name: "Comprueba la nomenclatura de cada archivo"
      text: "Muchos enunciados definen un patrón de nombre distinto para el informe, la presentación, el reporte de participación y el video. Compáralos uno por uno antes de subir nada."
    - name: "Lee el nivel más alto de cada criterio de la rúbrica"
      text: "La columna satisfactoria describe exactamente qué tiene que estar presente para el puntaje completo. Léela como una lista de condiciones, no como una descripción, y contrástala con tu documento."
faq:
  - q: "¿Esto no es que la IA haga mi trabajo?"
    a: "No, porque no escribe el trabajo: lo compara con lo que pidieron. El insumo es tu propio documento ya escrito y dos documentos que el profesor publicó para que los leas. Lo que devuelve es qué falta según esos criterios, que es la misma revisión que harías tú con el enunciado al lado y tiempo de sobra."
  - q: "¿Por qué se pierden puntos en algo tan básico como el nombre de un archivo?"
    a: "Porque un enunciado largo puede definir cuatro convenciones de nombre distintas, en una página que leíste semanas antes de entregar. No es desconocimiento: es que verificar decenas de requisitos a mano, al final de un trabajo de meses, no es algo que la gente haga bien."
  - q: "¿Dónde está la rúbrica en Blackboard?"
    a: "En el libro de calificaciones, entrando a la actividad y abriendo el enlace que dice que el elemento está calificado con una rúbrica. Es una pantalla distinta de la del enunciado, y por eso mucha gente nunca la abre: cada criterio trae su peso y la descripción del nivel satisfactorio."
  - q: "¿Sirve si la entrega es grupal?"
    a: "Sirve más. En un trabajo grupal cada integrante escribe su parte y nadie lee el documento completo contra el enunciado. Además, varios cursos califican de forma individual dentro de una entrega grupal, así que los requisitos que piden evidencia por integrante son justo los que se olvidan."
summary:
...
1. Revisar el Anexo A, la sección del Student Outcome (ABET Student Outcome 4).
2. La nomenclatura de los archivos de la entrega.
3. Para cada segmento se requieren de 3 a 5 entrevistas.
4. La documentación del API, que debe incluir descripción y ejemplo para todos los tipos de request.
...
1. **Junta las dos fuentes.** El enunciado y la rúbrica. Si solo revisas una, te falta la mitad.
2. **Convierte el índice en casillas.** Cada subsección numerada es una línea. Marca las que existen de verdad, no las que están solo como título.
3. **Caza los números.** Cuántas entrevistas, cuántos endpoints, cuántas horas por tarea. Son verificables y son los que más se incumplen.
4. **Compara los nombres de archivo uno por uno.** Es lo más tonto y lo más caro.
5. **Lee la columna satisfactoria de cada criterio** como una lista de condiciones.
