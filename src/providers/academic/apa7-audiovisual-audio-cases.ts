...
export const audiovisualAudioCases: Record<AudiovisualAudioCaseId, Apa7VerifiedAudiovisualAudioCase> = {
  ...
  'television-episode-or-webisode': {
    ...
    referenceTemplate: 'Una persona con ambos roles: Responsable, R. R. (Guionista y Director). Personas distintas: Guionista(s), G. G. (Guionista[s]), & Director, D. D. (Director). (Año, día de mes). Título (Temporada x, Episodio y) [Episodio de serie de TV]. En P. Productor (Productor ejecutivo); P. Productor, & Q. Productor (Productores ejecutivos); o lista completa: P. Productor, Q. Productor, & R. Productor (Productores ejecutivos), Título de la serie. Productora(s). Añade URL solo si existe un localizador público específico; de lo contrario, termina en la productora.',
    ...
    rules: ['Si una persona desempeña guion y dirección, escríbela una sola vez con ambos roles; si son personas distintas, incluye cada responsable con su rol.', 'Incluye la lista completa de productores ejecutivos de la serie y usa el rol plural cuando corresponda.', 'Omite la URL para una emisión o versión de streaming ordinaria sin localizador público específico.', 'Incluye temporada y episodio entre paréntesis después del título.', 'Distingue responsables del episodio de productores ejecutivos de la serie.'],
  },
  'ted-talk': {
  ...
  'song-or-track': {
    ...
    referenceTemplate: 'Autor musical. (Año). Título de la canción [Canción; grabada por Intérprete si corresponde]. En Título del álbum, si existe. Discográfica(s). Añade (Obra original publicada en Año original) solo cuando exista un año original verificado.',
  ...
  'podcast-series': {
    ...
    referenceTemplate: 'Responsable, R. R. (Anfitrión o Productor ejecutivo); Responsable, R. R., & Responsable, S. S. (Anfitriones o Productores ejecutivos); o lista completa: Responsable, R. R., Responsable, S. S., & Responsable, T. T. (Anfitriones o Productores ejecutivos). (Año único; Año inicial–Año final; o Año inicial–presente). Título [Pódcast de audio o video]. Productora. URL',
  ...
  'podcast-episode': {
    ...
    referenceTemplate: 'Responsable, R. R. (Anfitrión o Productor ejecutivo); Responsable, R. R., & Responsable, S. S. (Anfitriones o Productores ejecutivos); o lista completa: Responsable, R. R., Responsable, S. S., & Responsable, T. T. (Anfitriones o Productores ejecutivos). (Año, día de mes). Título (N.º x) [Episodio de pódcast de audio o video]. En Título del pódcast. Productora. URL',
