...
export const audiovisualAudioCases: Record<AudiovisualAudioCaseId, Apa7VerifiedAudiovisualAudioCase> = {
  ...
  'podcast-series': {
    ...
    referenceTemplate: 'Responsable, R. R. (Anfitrión o Productor ejecutivo), o Responsable, R. R., & Responsable, S. S. (Anfitriones o Productores ejecutivos). (Año único; Año inicial–Año final; o Año inicial–presente). Título [Pódcast de audio o video]. Productora. URL',
