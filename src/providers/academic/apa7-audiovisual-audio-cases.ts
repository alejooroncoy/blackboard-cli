...
export const audiovisualAudioCases: Record<AudiovisualAudioCaseId, Apa7VerifiedAudiovisualAudioCase> = {
  ...
  'television-series': {
    ...
    referenceTemplate: 'Productor, P. P. (Productor ejecutivo), o Productor, P. P., & Productor, Q. Q. (Productores ejecutivos). (Año inicial–Año final o presente). Título de la serie [Serie de TV]. Productora(s).',
    ...
    rules: ['Los productores ejecutivos ocupan la posición de autor.', 'Incluye la lista completa y usa el rol plural cuando se acredita a más de un productor ejecutivo.', 'Usa un rango para una serie concluida y “Año inicial–presente” para una serie en emisión.'],
  },
  'television-episode-or-webisode': {
  ...
  'podcast-series': {
    ...
    referenceTemplate: 'Responsable, R. R. (Anfitrión o Productor ejecutivo), o Responsable, R. R., & Responsable, S. S. (Anfitriones o Productores ejecutivos). (Año inicial–presente o Año inicial–Año final). Título [Pódcast de audio o video]. Productora. URL',
    parentheticalCitation: '(Responsable, Años); (Responsable & Responsable, Años); (Primer responsable et al., Años) con tres o más responsables', narrativeCitation: 'Responsable (Años); Responsable y Responsable (Años); Primer responsable et al. (Años) con tres o más responsables',
    rules: ['El anfitrión ocupa la posición de autor; alternativamente, usa la lista completa de productores ejecutivos conocidos.', 'Conserva todos los responsables acreditados del rol elegido y usa el rol plural cuando corresponda.', 'Incluye el rol y especifica si es pódcast de audio o video.', 'Si la URL se desconoce porque se accedió desde una aplicación, omítela.'],
  },
  'podcast-episode': {
    ...
    referenceTemplate: 'Responsable, R. R. (Anfitrión o Productor ejecutivo), o Responsable, R. R., & Responsable, S. S. (Anfitriones o Productores ejecutivos). (Año, día de mes). Título (N.º x) [Episodio de pódcast de audio o video]. En Título del pódcast. Productora. URL',
