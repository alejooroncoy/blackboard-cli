...
export const audiovisualAudioCases: Record<AudiovisualAudioCaseId, Apa7VerifiedAudiovisualAudioCase> = {
  ...
  'recorded-webinar': {
    ...
    requiredMetadata: ['instructor o instructores', 'año o fecha', 'título', 'organización', 'URL recuperable'],
    referenceTemplate: 'Un instructor: Instructor, I. I. (Año). Título [Seminario web]. Organización. URL Dos: Instructor, I. I., & Instructor, J. J. (Año). Título [Seminario web]. Organización. URL De 3 a 20: Instructor, I. I., Instructor, J. J., Instructor, K. K., …, & Instructor final, Z. Z. (Año). Título [Seminario web]. Organización. URL 21 o más: instructores 1–19, …, Último instructor (Año). Título [Seminario web]. Organización. URL',
    parentheticalCitation: '(Instructor, Año); (Instructor & Instructor, Año); (Primer instructor et al., Año) con tres o más instructores', narrativeCitation: 'Instructor (Año); Instructor y Instructor (Año); Primer instructor et al. (Año) con tres o más instructores',
    rules: ['Incluye la lista completa y ordenada de instructores acreditados conforme a los límites del elemento autor de APA.', 'Este formato es solo para webinars grabados y recuperables.', 'Un webinar no grabado se cita como comunicación personal y no entra en referencias.'],
  },
  'online-video': {
