...
export const audiovisualAudioCases: Record<AudiovisualAudioCaseId, Apa7VerifiedAudiovisualAudioCase> = {
  ...
  'television-episode-or-webisode': {
    ...
    referenceTemplate: 'Una persona con ambos roles: Responsable, R. R. (Guionista y Director). Personas distintas: Guionista(s), G. G. (Guionista[s]), & Director, D. D. (Director). (Año, día de mes). Título (Temporada x, Episodio y) [Episodio de serie de TV]. En P. Productor (Productor ejecutivo); P. Productor, & Q. Productor (Productores ejecutivos); o lista completa: P. Productor, Q. Productor, & R. Productor (Productores ejecutivos), Título de la serie. Productora(s). URL',
