...
const referenceTemplates: Partial<Record<SourceType, string>> = {
  book: 'Con autor o editor acreditado: Autor, A. A.; Autor, A. A., & Autor, B. B.; o lista completa conforme a APA. (Año). *Título del libro* (edición, desde la segunda). Editorial. Sin autor ni editor acreditado: *Título del libro*. (Año). Editorial. Sin autor, la cita parentética usa (*Título abreviado*, Año) y la narrativa usa *Título abreviado* (Año). Añade DOI si existe; si no, añade una URL pública cuando corresponda; para una obra impresa o de base académica común sin DOI, omite DOI y URL.',
