...
const referenceTemplates: Partial<Record<SourceType, string>> = {
  ...
  'newspaper-article': 'Con autor: Autor, A. A.; Autor, A. A., & Autor, B. B.; o lista completa conforme a APA. (Año, día de mes). Título. *Periódico*, x o xx–xx para versión impresa. URL para versión en línea. Sin autor acreditado: Título. (Año, día de mes). *Periódico*, x o xx–xx para versión impresa. URL para versión en línea. Sin autor, la cita parentética usa (“Título abreviado”, Año) y la narrativa usa “Título abreviado” (Año).',
  'video-webinar': 'Video en línea: Autor o entidad. (Año, día de mes). *Título* [Video]. Plataforma. URL; usa la fecha completa publicada. Seminario web grabado: Instructor, I. I. (Año). *Título* [Seminario web]. Organización. URL; usa solo el año aunque se conozcan mes y día. Un webinar no grabado se cita como comunicación personal.',
