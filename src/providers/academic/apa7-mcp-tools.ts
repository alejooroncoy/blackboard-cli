...
const referenceTemplates: Partial<Record<SourceType, string>> = {
  ...
  'newspaper-article': 'Autor, A. A.; Autor, A. A., & Autor, B. B.; o lista completa conforme a APA. (Año, día de mes). Título. *Periódico*, x o xx–xx para versión impresa. URL para versión en línea',
