...
export const visualSocialWebCases: Record<VisualSocialWebCaseId, Apa7VerifiedVisualSocialWebCase> = {
  ...
  'webpage-news-site': {
    ...
    referenceTemplate: 'Un autor: Autor, A. A. (Año, día de mes). Dos: Autor, A. A., & Autor, B. B. (Año, día de mes). De 3 a 20: Autor, A. A., Autor, B. B., …, & Último autor, Z. Z. (Año, día de mes; incluye todos). 21 o más: autores 1–19, …, Último autor (Año, día de mes). En todos los casos personales: Título de la página. Sitio de noticias. URL\nEntidad autora: Entidad. (Año, día de mes). Título de la página. Sitio de noticias, solo si difiere de la entidad autora. URL',
    ...
    rules: ['Conserva la lista completa y ordenada de autores personales conforme a los límites del elemento autor de APA.', 'Cuando la responsable es una entidad, consérvala literalmente en posición de autor y omite el sitio si coincide con ella.', 'Usa este caso para noticias de sitios como CNN, BBC o HuffPost que no son ediciones de un periódico.', 'Un artículo de revista o periódico en línea usa el caso periódico correspondiente.'],
  },
  'webpage-group-author': {
