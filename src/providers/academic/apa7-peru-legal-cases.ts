...
export const peruLegalCases: Record<PeruLegalCaseId, PeruLegalCase> = {
  'peru-constitution-general': legalCase({
    ...
    referenceTemplate: 'No lleva entrada si es solo una mención general y la institución adopta la excepción de la sección 11.9. Si exige documentar la edición: Constitución Política del Perú. (Año de la edición). Congreso de la República. URL oficial, solo si existe.',
  ...
  'peru-constitution-article': legalCase({
    ...
    referenceTemplate: 'Constitución Política del Perú [Const.], art. X (1993). Congreso de la República. URL oficial, solo si existe.',
  ...
  'peru-law-or-legislative-decree': legalCase({
    ...
    referenceTemplate: 'Tipo de norma N.º XXXX, Título oficial. (día de mes de año de publicación). Diario Oficial El Peruano. URL oficial, solo si existe.',
    parentheticalCitation: '(Tipo de norma N.º XXXX, Año) para la norma completa; (Tipo de norma N.º XXXX, Año, art. X) para una disposición específica verificada',
    narrativeCitation: 'La Tipo de norma N.º XXXX (Año)… para la norma completa; el artículo X de la Tipo de norma N.º XXXX (Año)… para una disposición específica verificada',
  ...
  'peru-regulation-or-executive-norm': legalCase({
    ...
    referenceTemplate: 'Tipo N.º XXXX-AAAA-SIGLA, Título o asunto. (día de mes de año). Entidad emisora o Diario Oficial El Peruano. URL oficial, solo si existe.',
    parentheticalCitation: '(Tipo N.º XXXX-AAAA-SIGLA, Año) para la norma completa; (Tipo N.º XXXX-AAAA-SIGLA, Año, art. X) para una disposición específica verificada',
  ...
  'peru-legislative-bill': legalCase({
    ...
    referenceTemplate: 'Proyecto de Ley N.º XXXX/AAAA-CR, Título. (día de mes de año de presentación). Congreso de la República. URL oficial, solo si existe.',
  ...
  'peru-constitutional-court-decision': legalCase({
    ...
    referenceTemplate: 'Sentencia recaída en el Expediente N.º XXXXX-AAAA-TIPO/TC (Tribunal Constitucional del Perú, Sala o Pleno, día de mes de año). URL oficial, solo si existe.',
    parentheticalCitation: '(Sentencia del Expediente N.º XXXXX-AAAA-TIPO/TC, Año) para la decisión completa; (Sentencia del Expediente N.º XXXXX-AAAA-TIPO/TC, Año, fundamento X) para un pasaje específico verificado',
    narrativeCitation: 'La Sentencia del Expediente N.º XXXXX-AAAA-TIPO/TC (Año)… para la decisión completa; en el fundamento X de la Sentencia del Expediente N.º XXXXX-AAAA-TIPO/TC (Año), el Tribunal Constitucional… para un pasaje específico verificado',
  ...
  'peru-judicial-decision': legalCase({
    ...
    referenceTemplate: 'Tipo de decisión N.º XXXX-AAAA/LOCALIDAD (Corte/Sala del Poder Judicial, día de mes de año). URL oficial, solo si existe.',
    parentheticalCitation: '(Tipo de decisión N.º XXXX-AAAA/LOCALIDAD, Año) para la decisión completa; (Tipo de decisión N.º XXXX-AAAA/LOCALIDAD, Año, fundamento X) para un pasaje específico verificado',
    narrativeCitation: 'La Tipo de decisión N.º XXXX-AAAA/LOCALIDAD (Año)… para la decisión completa; el fundamento X de la Tipo de decisión N.º XXXX-AAAA/LOCALIDAD (Año)… para un pasaje específico verificado',
  ...
  'peru-administrative-resolution': legalCase({
    ...
    referenceTemplate: 'Tipo de resolución N.º XXXX-AAAA-ENTIDAD/ÓRGANO, Título o asunto (Entidad, día de mes de año). URL oficial, solo si existe.',
    parentheticalCitation: '(Tipo de resolución N.º XXXX-AAAA-ENTIDAD/ÓRGANO, Año) para la resolución completa; (Tipo de resolución N.º XXXX-AAAA-ENTIDAD/ÓRGANO, Año, fundamento X) para un pasaje específico verificado',
  ...
  'peru-patent': legalCase({
    ...
    referenceTemplate: 'Un inventor: Inventor, A. A.; dos: Inventor, A. A., & Inventor, B. B.; de 3 a 20: Inventor, A. A., Inventor, B. B., Inventor, C. C., …, & Inventor final, Z. Z. (incluye todos); 21 o más: inventores 1–19, …, Último inventor. (Año de concesión). Título de la patente (Patente peruana N.º XXXXX). Indecopi. URL oficial, solo si existe.',
  ...
  'peru-treaty': legalCase({
    ...
    referenceTemplate: 'Nombre oficial del tratado o convención, día de mes de año. Archivo Nacional de Tratados, código si aparece. URL oficial, solo si existe.',
    parentheticalCitation: '(Nombre abreviado inequívoco del tratado, Año) para el tratado completo; (Nombre abreviado inequívoco del tratado, Año, art. X) para un artículo específico verificado',
    narrativeCitation: 'El Nombre oficial o abreviado del tratado (Año)… para el tratado completo; el artículo X del Nombre oficial o abreviado del tratado (Año)… para un artículo específico verificado',
