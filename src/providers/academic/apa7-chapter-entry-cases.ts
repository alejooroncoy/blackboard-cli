...
export const chapterEntryCases: Record<ChapterEntryCaseId, Apa7VerifiedChapterEntryCase> = {
  ...
  'chapter-other-language': {
    ...
    referenceTemplate: `${completeChapterAuthors} (Año). Título original del capítulo [Traducción del título]. En ${completeChapterEditors}, Título del libro (edición y volumen: edición, Vol. x, pp. xx-xx; solo edición: edición, pp. xx-xx; solo volumen: Vol. x, pp. xx-xx; sin ambos: pp. xx-xx). Editorial. Con DOI: añade https://doi.org/xxxxx al final. Con URL pública sin DOI: añade URL al final. Impreso o base académica común sin localizador: termina en la editorial.`,
    rules: [completeChapterAuthorRule, 'Añade entre corchetes la traducción del título del capítulo cuando su idioma difiere del idioma del trabajo.', 'Incluye edición y volumen solo cuando existan.', 'Prefiere DOI y exprésalo como URL completa https://doi.org/...; usa URL pública si no hay DOI y omite ambos en una versión impresa o base académica común sin localizador.'],
  },
  'chapter-translated-republication': {
    ...base, id: 'chapter-translated-republication', label: 'Capítulo reeditado en traducción', manualExample: 42, manualPrintedPages: '333',
    requiredMetadata: ['autor', 'año original', 'año de reedición', 'título', 'traductores del capítulo', 'editores', 'libro', 'edición si existe', 'volumen si existe', 'páginas', 'editorial', 'DOI o URL pública si corresponde'],
    referenceTemplate: `${completeChapterAuthors} (Año reedición). Título del capítulo (${titlePositionChapterTranslators}). En ${completeChapterEditors}, Título del libro (edición y volumen: edición, Vol. x, pp. xx-xx; solo edición: edición, pp. xx-xx; solo volumen: Vol. x, pp. xx-xx; sin ambos: pp. xx-xx). Editorial. Con DOI: añade https://doi.org/xxxxx. Con URL pública sin DOI: añade URL. Impreso o base académica común sin localizador: termina después de la editorial. En todos los casos, finaliza con (Obra original publicada en Año original).`,
    ...
    rules: ['Conserva la lista completa de traductores acreditados y usa (Trad.) para uno o (Trads.) para varios.', 'Incluye edición y volumen solo cuando existan.', 'Prefiere DOI y exprésalo como URL completa https://doi.org/...; usa URL pública si no hay DOI y omite ambos en una versión impresa o base académica común sin localizador.', 'La nota de obra original publicada va siempre al final, después del DOI o URL cuando exista.', 'La cita de la versión consultada conserva el año original y el de la reedición.'],
  },
  'chapter-reprinted-from-journal': {
  ...
  'chapter-multivolume-work': {
    ...
    referenceTemplate: `${completeChapterAuthors} (Año). Título del capítulo. En ${completeChapterEditors}, Con título propio: Título general: Vol. x. Título del volumen (edición, solo si existe; pp. xx-xx). Sin título propio: Título general (edición, solo si existe; Vol. x, pp. xx-xx). Editorial. Con DOI/URL: con DOI añade https://doi.org/xxxxx al final; con URL pública sin DOI añade URL al final; impreso o base académica común sin localizador termina en la editorial.`,
  ...
  'work-in-anthology': {
    ...
    requiredMetadata: ['autor de la obra', 'año de la antología', 'título de la obra', 'editor de la antología', 'título de la antología', 'páginas', 'editorial', 'DOI/URL si corresponde', 'año original si ya se publicó'],
    referenceTemplate: `${completeChapterAuthors} (Año antología). Título de la obra. En ${completeChapterEditors}, Título de la antología (pp. xx-xx). Editorial. Con DOI: añade https://doi.org/xxxxx. Con URL pública sin DOI: añade URL. Sin localizador: termina después de la editorial. Si hubo una publicación anterior verificada, finaliza con (Obra original publicada en Año original).`,
