...
export const chapterEntryCases: Record<ChapterEntryCaseId, Apa7VerifiedChapterEntryCase> = {
  ...
  'chapter-translated-republication': {
    ...
    referenceTemplate: `${completeChapterAuthors} (Año reedición). Título del capítulo (${titlePositionChapterTranslators}). En ${completeChapterEditors}, Título del libro (edición y volumen: edición, Vol. x, pp. xx-xx; solo edición: edición, pp. xx-xx; solo volumen: Vol. x, pp. xx-xx; sin ambos: pp. xx-xx). Editorial. (Obra original publicada en Año original). Con DOI: añade DOI al final. Con URL pública sin DOI: añade URL al final. Impreso o base académica común sin localizador: termina en la nota de obra original.`,
    ...
    rules: ['Conserva la lista completa de traductores acreditados y usa (Trad.) para uno o (Trads.) para varios.', 'Incluye edición y volumen solo cuando existan.', 'Prefiere DOI; usa URL pública si no hay DOI y omite ambos en una versión impresa o base académica común sin localizador.', 'La cita de la versión consultada conserva el año original y el de la reedición.'],
  },
  'chapter-reprinted-from-journal': {
