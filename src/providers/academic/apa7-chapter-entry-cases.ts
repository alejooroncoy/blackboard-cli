...
export const chapterEntryCases: Record<ChapterEntryCaseId, Apa7VerifiedChapterEntryCase> = {
  ...
  'work-in-anthology': {
    ...
    referenceTemplate: `${completeChapterAuthors} (Año antología). Título de la obra. En ${completeChapterEditors}, Título de la antología (pp. xx-xx). Editorial. (Obra original publicada en Año original, solo si hubo una publicación anterior verificada). Añade DOI/URL solo si corresponde al final.`,
