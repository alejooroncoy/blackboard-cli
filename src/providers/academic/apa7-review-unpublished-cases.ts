...
export const reviewUnpublishedCases: Record<ReviewUnpublishedCaseId, Apa7VerifiedReviewUnpublishedCase> = {
  ...
  'review-book-in-newspaper': {
    ...
    referenceTemplate: `${completeReviewers} (Año, día de mes). Título de la reseña [Reseña del libro Título, de A. Autor]. Periódico, p. x para una página o pp. xx–xx para varias páginas en versión impresa. URL para versión en línea`,
