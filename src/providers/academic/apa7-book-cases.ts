...
export const bookCases: Record<BookCaseId, Apa7VerifiedBookCase> = {
  ...
  'book-author-electronic-public-url': {
    ...
    referenceTemplate: `Libro electrónico: ${completeAuthorList} (Año). Título del libro (edición, solo desde la segunda). Editorial. URL
Audiolibro: ${completeAuthorList} (Año). Título del libro (${titlePositionNarrators}; edición, solo desde la segunda) [Audiolibro]. Editorial. URL`,
  ...
  'book-edited-no-doi-database-or-print': {
    ...
    requiredMetadata: ['editores', 'año', 'título', 'edición desde la segunda', 'editorial'],
    referenceTemplate: `${completeEditorList}. (Año). Título del libro (edición, solo desde la segunda). Editorial.`,
    parentheticalCitation: '(Editor, Año); (Editor & Editor, Año); (Primer editor et al., Año) con tres o más editores', narrativeCitation: 'Editor (Año); Editor y Editor (Año); Primer editor et al. (Año) con tres o más editores',
    rules: ['Incluye la lista completa de editores y usa (Ed.) para uno o (Eds.) para varios.', 'Incluye la edición desde la segunda; omite todo el paréntesis para la primera.', 'No incluye nombre ni URL de la base de datos.'],
  },
  'book-edited-electronic-public-url': {
    ...
    referenceTemplate: `Libro electrónico: ${completeEditorList}. (Año). Título del libro (edición, solo desde la segunda). Editorial. URL
Audiolibro: ${completeEditorList}. (Año). Título del libro (${titlePositionNarrators}; edición, solo desde la segunda) [Audiolibro]. Editorial. URL`,
    parentheticalCitation: '(Editor, Año); (Editor & Editor, Año); (Primer editor et al., Año) con tres o más editores', narrativeCitation: 'Editor (Año); Editor y Editor (Año); Primer editor et al. (Año) con tres o más editores',
  ...
  'book-translated-republication': {
    ...
    referenceTemplate: `${completeAuthorList} (Año reedición). Título (${titlePositionTranslators}; edición, solo desde la segunda). Editorial. Con DOI: añade https://doi.org/xxxxx. Con URL pública sin DOI: añade URL. Impreso o base académica común sin localizador: termina después de la editorial. En todos los casos, finaliza con (Obra original publicada en Año original).`,
    ...
    rules: [completeAuthorRule, 'Conserva la lista completa de traductores acreditados y usa (Trad.) para uno o (Trads.) para varios.', 'Conserva ambos años en la cita.', 'Prefiere DOI y exprésalo como URL completa https://doi.org/...; usa URL pública si no hay DOI y omite ambos en una versión impresa o base académica común sin localizador.', 'La nota de obra original publicada va siempre al final, después del DOI o URL cuando exista.'],
  },
  'book-republished': {
    ...
    referenceTemplate: `${completeAuthorList} (Año reedición). Título (responsable, función, solo si se acredita) [Formato, solo si aplica]. Editorial. Con DOI: añade https://doi.org/xxxxx. Con URL pública sin DOI: añade URL. Impreso o base académica común sin localizador: termina después de la editorial. En todos los casos, finaliza con (Obra original publicada en Año original).`,
    parentheticalCitation: '(Autor, Año original/Año reedición); (Autor & Autor, Año original/Año reedición); (Primer autor et al., Año original/Año reedición) con tres o más autores', narrativeCitation: 'Autor (Año original/Año reedición); Autor y Autor (Año original/Año reedición); Primer autor et al. (Año original/Año reedición) con tres o más autores',
    rules: ['Describe la versión efectivamente consultada.', 'Omite el paréntesis de responsable, los corchetes de formato y el localizador cuando esos elementos no correspondan.', 'Prefiere DOI y exprésalo como URL completa https://doi.org/...; usa URL pública solo si no existe DOI.', 'La nota de obra original publicada va siempre al final, después del DOI o URL cuando exista.', 'Un audiolibro publicado en año diferente se trata como reedición.'],
  },
  'book-multivolume-single-volume': {
    ...
    requiredMetadata: ['autores o editores del volumen', 'año', 'título general', 'número de volumen', 'título propio del volumen si existe', 'edición si existe', 'editorial', 'DOI/URL si corresponde'],
    referenceTemplate: `${completeAuthorList} (Año). Sin título propio: Título general (edición, solo desde la segunda; Vol. x) o Título general (Vol. x) si es primera o no se declara edición. Con título propio: Título general: Vol. x. Título del volumen (edición, solo desde la segunda). Editorial. Con DOI/URL: con DOI añade https://doi.org/xxxxx al final; con URL pública sin DOI añade URL al final; impreso o base académica común sin localizador termina en la editorial. Si el volumen se acredita a editores: ${completeEditorList}. (Año). Título y demás elementos.`,
    ...
    rules: [completeAuthorRule, 'Si el volumen no tiene título propio, el número va entre paréntesis sin cursiva.', 'Si tiene título propio, número y título siguen al título general.', 'Omite la edición cuando es primera o no se declara.', 'Añade DOI/URL solo cuando corresponda; en impreso o base académica común sin localizador termina en la editorial.', 'Cuando el volumen se acredita a editores, incluye la lista completa en posición de autor y añade (Ed.) o (Eds.) según corresponda.'],
  },
  'book-in-series': {
    ...
    referenceTemplate: `${completeAuthorList} (Año). Título del libro (edición, solo desde la segunda). Editorial. Con DOI: añade https://doi.org/xxxxx al final. Con URL pública sin DOI: añade URL al final. Impreso o base académica común sin localizador: termina en la editorial.`,
  ...
  'dictionary-thesaurus-encyclopedia': {
    ...
    requiredMetadata: ['autor grupal o editor', 'fecha o s. f.', 'título', 'edición/versión si existe', 'editorial si corresponde', 'DOI/URL si existe', 'fecha de recuperación si cambia sin archivo'],
    referenceTemplate: `Estable con DOI/URL: con edición/versión, Autor grupal. (Fecha o s. f.). Título de la obra (edición/versión). Editorial. Con DOI: https://doi.org/xxxxx; con URL pública sin DOI: URL. Sin edición/versión: Autor grupal. (Fecha o s. f.). Título de la obra. Editorial. Con DOI: https://doi.org/xxxxx; con URL pública sin DOI: URL. Cambiante sin archivo: Autor grupal. (s. f.). Título de la obra (edición/versión, si existe). Editorial. Recuperado el día de mes de año, de URL. Si se acredita a editores: ${completeEditorList}. (Fecha o s. f.). Título y demás elementos. Impreso o base académica común sin localizador: usa la misma forma con o sin edición/versión y termina en la editorial.`,
    ...
    rules: ['Distingue el autor grupal de los editores; para estos últimos incluye la lista completa y añade (Ed.) o (Eds.).', 'Omite la edición o versión cuando es primera o no se declara.', 'Omite DOI/URL en una obra impresa o de base académica común sin localizador.', 'Usa s. f. y fecha de recuperación para obras actualizadas continuamente sin versiones archivadas.', 'Omite fecha de recuperación para versiones estables o archivadas.'],
  },
  anthology: {
    ...
    referenceTemplate: `${completeEditorList}. (Año). Título de la antología. Editorial. Con DOI/URL: con DOI añade https://doi.org/xxxxx al final; con URL pública sin DOI añade URL al final. Impreso o base académica común sin localizador: termina en la editorial.`,
    parentheticalCitation: '(Editor, Año); (Editor & Editor, Año); (Primer editor et al., Año) con tres o más editores', narrativeCitation: 'Editor (Año); Editor y Editor (Año); Primer editor et al. (Año) con tres o más editores',
  ...
  'shakespeare-work': {
    ...
    referenceTemplate: `Con editor: Autor. (Año edición). Título (${titlePositionEditors}). Editorial. (Obra original publicada en Año original). Con traductor: Autor. (Año edición). Título (${titlePositionTranslators}). Editorial. (Obra original publicada en Año original)`,
