...
export const bookCases: Record<BookCaseId, Apa7VerifiedBookCase> = {
  ...
  'dictionary-thesaurus-encyclopedia': {
    ...
    referenceTemplate: `Estable con DOI/URL: con edición/versión, Autor grupal. (Fecha o s. f.). Título de la obra (edición/versión). Editorial. DOI/URL. Sin edición/versión: Autor grupal. (Fecha o s. f.). Título de la obra. Editorial. DOI/URL. Cambiante sin archivo: Autor grupal. (s. f.). Título de la obra (edición/versión, si existe). Editorial. Recuperado el día de mes de año, de URL. Si se acredita a editores: ${completeEditorList}. (Fecha o s. f.). Título y demás elementos. Impreso o base académica común sin localizador: usa la misma forma con o sin edición/versión y termina en la editorial.`,
