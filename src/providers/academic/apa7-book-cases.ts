...
export const bookCases: Record<BookCaseId, Apa7VerifiedBookCase> = {
  ...
  'book-author-editor-on-cover': {
    ...
    referenceTemplate: `${completeAuthorList} (Año). Título del libro (E. Editor, Ed.; edición, solo desde la segunda). Editorial. Con DOI: añade DOI al final. Con URL pública sin DOI: añade URL al final. Impreso o base académica común sin localizador: termina en la editorial.`,
    rules: ['El autor, no el editor, determina la cita.', 'El editor aparece entre paréntesis después del título.', 'Incluye la edición desde la segunda en el mismo paréntesis, después del editor; omite únicamente ese segmento para la primera.', 'Prefiere DOI; usa URL pública si no hay DOI y omite ambos en una versión impresa o base académica común sin localizador.'],
  },
  'book-edited-doi-multiple-publishers': {
  ...
  'dictionary-thesaurus-encyclopedia': {
    ...
    referenceTemplate: `Con DOI/URL: con edición/versión, Autor grupal. (Fecha o s. f.). Título de la obra (edición/versión). Editorial. DOI/URL. Sin edición/versión: Autor grupal. (Fecha o s. f.). Título de la obra. Editorial. DOI/URL. Si se acredita a editores: ${completeEditorList}. (Fecha o s. f.). Título y demás elementos. Impreso o base académica común sin localizador: usa la misma forma con o sin edición/versión y termina en la editorial. Añade fecha de recuperación solo si cambia sin archivo.`,
  ...
  'religious-work': {
    ...
    referenceTemplate: 'Sin URL: Título de la obra. (Año de versión). Editorial. (Obra original publicada en Año original, solo si se conoce y corresponde). Con URL: Título de la obra. (Año de versión). Editorial. (Obra original publicada en Año original, solo si se conoce y corresponde). URL. Con traductor: añade (T. Traductor, Trad.) después del título; con edición: (2.ª ed.); con ambos: (T. Traductor, Trad.; 2.ª ed.).',
  ...
  'ancient-greek-roman-work': {
    ...
    referenceTemplate: 'Con traductor, sin URL: Autor. (Año versión). Título (T. Traductor, Trad.). Editorial. (Obra original publicada en Año antiguo exacto) o (Obra original publicada ca. Año antiguo aproximado). Con URL, coloca esa nota antes de la URL final. Con editor: sustituye (T. Traductor, Trad.) por (E. Editor, Ed.).',
