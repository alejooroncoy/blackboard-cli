# ChatGPT y Blackboard: cuánto tiempo pierdes copiando archivos a mano

> Comparamos el método manual (buscar, descargar y subir archivos de Blackboard a ChatGPT o Claude) contra usar Campus, que los conecta directo. Incluye el caso de revisar tu enunciado a fondo.

Fuente: https://campuscli.com/blog/chatgpt-blackboard-sin-copiar-archivos/
...
**¿Puedo conectar ChatGPT con Blackboard?**

Sí. Con un conector MCP, ChatGPT consulta tus cursos, tareas, notas y materiales del Aula Virtual directamente, sin que copies y pegues archivos ni compartas tu contraseña de la universidad.

**¿Es seguro conectar mi Aula Virtual a una IA?**

El inicio de sesión ocurre en la página de la propia universidad, no en Campus, así que tu contraseña nunca pasa por el conector. La sesión queda cifrada y puedes revocarla cuando quieras.
